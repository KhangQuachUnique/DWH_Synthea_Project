...
#### Sửa thằng tên server trong 2 file python 02 và 05 luôn
...
```bash
# Kiểm tra setup, không cần làm, miễn bước 6 chạy xong check table có data không báo lỗi là được
python 04_Validation.py
```

### 8. Tạo DWH schema và procedures transform to DWH

Chạy 2 file SQL trong SQL Server Management Studio (SSMS):

- `06_Schema_DWH.sql` - Tạo database DWH
- `07_Procedures_Staging_to_DWH.sql` - Tạo procedures

### 9. Chạy transform to DWH

Chạy 1 file SQL trong SQL Server Management Studio (SSMS):

- `run_transform_to_dwh.sql`
