...
BEGIN
    ...
    BEGIN TRY
        ...
        WHEN NOT MATCHED BY TARGET THEN
            INSERT (Id,BIRTHDATE,DEATHDATE,SSN,DRIVERS,PASSPORT,PREFIX,FIRST,LAST,SUFFIX,MAIDEN,MARITAL,RACE,ETHNICITY,GENDER,BIRTHPLACE,ADDRESS,CITY,STATE,COUNTY,ZIP,LAT,LON,HEALTHCARE_EXPENSES,HEALTHCARE_COVERAGE,create_at,update_at)
            VALUES (s.Id,s.BIRTHDATE,s.DEATHDATE,s.SSN,s.DRIVERS,s.PASSPORT,s.PREFIX,s.FIRST,s.LAST,s.SUFFIX,s.MAIDEN,s.MARITAL,s.RACE,s.ETHNICITY,s.GENDER,s.BIRTHPLACE,s.ADDRESS,s.CITY,s.STATE,s.COUNTY,s.ZIP,s.LAT,s.LON,s.HEALTHCARE_EXPENSES,s.HEALTHCARE_COVERAGE,SYSUTCDATETIME(),s.update_at);
