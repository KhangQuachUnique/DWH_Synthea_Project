...
BEGIN
    ...
    BEGIN TRY
        ...
        WHEN NOT MATCHED BY TARGET THEN
            INSERT (START,STOP,PATIENT,PAYER,ENCOUNTER,CODE,DESCRIPTION,BASE_COST,PAYER_COVERAGE,DISPENSES,TOTALCOST,REASONCODE,REASONDESCRIPTION,create_at,update_at,batch_id)
            VALUES (s.START,s.STOP,s.PATIENT,s.PAYER,s.ENCOUNTER,s.CODE,s.DESCRIPTION,s.BASE_COST,s.PAYER_COVERAGE,s.DISPENSES,s.TOTALCOST,s.REASONCODE,s.REASONDESCRIPTION,SYSUTCDATETIME(),s.update_at,s.batch_id);
