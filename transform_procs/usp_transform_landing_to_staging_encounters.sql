...
BEGIN
    ...
    BEGIN TRY
        ...
        WHEN NOT MATCHED BY TARGET THEN
            INSERT (Id,START,STOP,PATIENT,ORGANIZATION,PROVIDER,PAYER,ENCOUNTERCLASS,CODE,DESCRIPTION,BASE_ENCOUNTER_COST,TOTAL_CLAIM_COST,PAYER_COVERAGE,REASONCODE,REASONDESCRIPTION,create_at,update_at,batch_id)
            VALUES (s.Id,s.START,s.STOP,s.PATIENT,s.ORGANIZATION,s.PROVIDER,s.PAYER,s.ENCOUNTERCLASS,s.CODE,s.DESCRIPTION,s.BASE_ENCOUNTER_COST,s.TOTAL_CLAIM_COST,s.PAYER_COVERAGE,s.REASONCODE,s.REASONDESCRIPTION,SYSUTCDATETIME(),s.update_at,s.batch_id);
